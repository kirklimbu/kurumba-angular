...
export class InternalComponent implements OnInit {
  ...
  buildForm() {
    ...
    this.examForm = this.fb.group({   // start from here
      student: [this.createMarks.student],
      marksList: [this.fb.array([this.buildMarkList()])]
  ...
  setMarksList() {
    console.log('calling set mark list');

    let control = <FormArray>this.examForm.controls.markList;
    this.createMarks.marksList.forEach(x => {
  ...
  get marksList() {
    return
    // this.examForm.get('markList')['controls'];
  }
  ...
  marksListCollection() {
    return this.examForm.get('markList') as FormArray;
  }

  buildMarkList() {
     this.fb.group({  // form define garne
      year: this.year.year,
      terminal: this.terminal.terminal,
      className: [this.class.className],
      subject: [this.subjectx.subjectId],
      prMarks: [],
      thMarks: []

...
export class TeacherFormComponent implements OnInit {
  ...
  buildteacherForm() {
    ...
    this.teacherForm = this.fb.group({
      ...
      subjectList: this.fb.array([this.buildTeacherSubjectForm()]),
  ...
  //   let control = <FormArray>this.teacherForm.controls.subjectList;
  ...
  buildTeacherSubjectForm() {
    const add = this.teacherForm.get('subjectList') as FormArray;
  ...
  // test
  // addNewAddressGroup() {
  //   console.log('inside add new address');
  ...
  getClassErrorMessage() {
    // return this..controls['classId'].hasError('required') ? 'Student class is required.' : '';
  }

...
export class ChangePasswordComponent implements OnInit {
  ...
  getOldPassErrorMessage() {
    return this.c.controls['name'].hasError('required') ? 'Student name is required.' :
      this.c.controls['name'].hasError('maxLength') ? 'Invalid name.' :
        this.c.controls['name'].hasError('minlength') ? 'Name must be atleast of 2 characters.' :
          '';
  }
}

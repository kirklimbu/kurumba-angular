...
export class ChangePasswordComponent implements OnInit {
  ...
  getNewPassErrorMessage() {
    return this.changePasswordForm.controls['newPass'].hasError('required') ? 'New Password name is required.' : '';
  }

  getConfirmPassErrorMessage() {
    return this.changePasswordForm.controls['confirmPass'].hasError('required') ? 'Confirm Password name is required.' : '';
  }
}
